  ...
  class ButtonController {
    ...
    createApiButton(buttonName, damage, crit) {
      ...
      const modifier = btn.math(damage, crit),
        ...
        buttonContent = `<a href="!token-mod ${selectOrTarget}--set bar${bar}_value|${tokenModCmd}${reportString}" style="${styles.buttonShared}${btn.style}">${btn.content}</a>`,
        buttonContent2 = btn.content2 ? `<a style="${styles.buttonShared}${btn.style2}">${btn.content2}</a>` : ``;
